...
variable "resource_group_name" {
  ...
  validation {
    condition     = startswith(var.resource_group_name, "rg-dps")
    error_message = "resource_group_name must start with the rg-dps prefix for this shared lab subscription."
  }
}
